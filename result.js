...
const results = {
    'freezing-baby': {
        ...
        feature: '1週間分まとめて作って冷凍保存、たべる時は温めるだけで離乳食が完成！買い物・調理・献立をそのままマネして離乳食をできる限り悩まず進めたい忙しいママ・パパにぴったりのタイプです。',
    ...
    'kondate': {
        ...
        bookFeatures: [
            ...
            '時短・簡単メニュー',
            '対象年齢：3歳〜6歳',
            '※1歳半～3歳未満のお子さまに使用する場合は、調味料を少なめに調整してお使いください。'
        ],
        recommended: [
            '毎日献立を考えるのが大変',
